...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 255, ; uint32_t number_of_assemblies_in_apk (0xff)
	i32 0, ; uint32_t bundled_assembly_name_width (0x0)
	i32 2, ; uint32_t number_of_assembly_store_files (0x2)
	i32 28, ; uint32_t number_of_dso_cache_entries (0x1c)
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [255 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 8
...
@.env.3 = private unnamed_addr constant [37 x i8] c"4c3af9c4-0d0c-4dde-87e7-30daf749576f\00", align 1
